...
import Milks from '../api/Milk.json';
  ...
  return (
    <div className="mt-28 mb-10 px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
      ...
      <div className="text-2xl  lg:text-3xl text-center ">
          <Title Heading='Fresh Milk & Pure Ghee' />
          </div>
        ...
        {Milks.map((milk, id) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <p className="text-base sm:text-lg text-gray-800">{milk.text}</p>
              <p className="text-base sm:text-lg text-gray-800">{milk.text2}</p>
              </div>
